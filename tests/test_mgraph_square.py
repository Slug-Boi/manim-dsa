...
class IterativeDfs(Scene):
    ...
    def construct(self):
        graph = {
            "0": (["1", "2"], Rectangle(color=BLUE, width=1, height=1)),
            "1": (["0", "2", "3", "4"], Rectangle(color=BLUE, width=1, height=1)),
            "2": (["0", "1"], Rectangle(color=BLUE, width=1, height=1)),
            "3": (["1", "5"], Circle(color=BLUE, radius=0.5)),
            "4": (["1"], Rectangle(color=BLUE, width=1, height=1)),
            "5": (["3", "6", "7", "8"], Rectangle(color=BLUE, width=1, height=1)),
            "6": (["5"], Rectangle(color=BLUE, width=1, height=1)),
            "7": (["5", "8"], Star(color=BLUE, n=5, outer_radius=0.5)),
            "8": (["5", "7", "9"], Rectangle(color=BLUE, width=1, height=1)),
            "9": (["8"], Rectangle(color=BLUE, width=1, height=1)),
        }
        start = "0"
